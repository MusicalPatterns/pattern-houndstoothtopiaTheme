...
const computeScaleForDimension: (specs: StandardSpecs, index: Ordinal<Array<Translation<Meters>>>) => Scale<Meters> =
    (specs: StandardSpecs, index: Ordinal<Array<Translation<Meters>>>): Scale<Meters> => {
